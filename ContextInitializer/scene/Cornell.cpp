...
namespace ContextTest
{
  ...
  RootGroup Cornell::getSceneRootGroup(optix::Context & context)
  {
	...
	//optix::Program vcmLightProgram = context->createProgramFromPTXFile( "test_hit.cu.ptx", "closestHitRecursive");
	...
	geometry_group->setAcceleration(context->createAcceleration("Trbvh", "Bvh")); // Trbvh Sbvh Bvh
