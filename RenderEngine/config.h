...
#define TEST_USING_CONTEX_INITIALIZER_PROGRAMS 1
#define TEST_USING_CONTEX_INITIALIZER_SCENE 0
#define TEST_USING_CONTEX_INITIALIZER TEST_USING_CONTEX_INITIALIZER_PROGRAMS || TEST_USING_CONTEX_INITIALIZER_SCENE